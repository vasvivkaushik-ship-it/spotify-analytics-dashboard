...
## Interactive Power BI Dashboard for Music Insights & Streaming Trends

### 🚀 Overview
The Spotify Analytics Dashboard is an interactive Power BI project built to transform raw music streaming data into meaningful and visually engaging insights. It provides a consolidated view of key metrics such as artist performance, song popularity, album distribution, and listening trends. By combining multiple visual elements with KPI-driven analysis, the dashboard makes it easier to explore patterns in music consumption and understand what drives engagement across the platform.
...
### 📂 Dataset Description
The dataset consists of Spotify music data, including artist names, track details, popularity scores, album types, explicit content indicators, duration of songs, and release timelines. These attributes enable multi-dimensional analysis of music trends and performance.
...
- Genre-based and playlist-level analysis
- Predictive analytics for identifying potential hit songs
- Enhanced interactivity and mobile-friendly dashboard design
